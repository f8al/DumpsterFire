...
def IgniteDumpsterFire( thisDumpsterFire, withUserInteraction ):
        ...
        if ( thisDumpsterFire.mDelayLaunch == True ):
                ...
                print( "Delayed ignition selected. Standing by until UTC", end=' ' )
...
def MainMenu():
        ...
        while ( notDone ): 
                ...
                print( r"   |  _ \ _   _ _ __ ___  _ __  ___| |_ ___ _ __|  ___( )_ __ ___    " )
                print( r"   | | | | | | | '_ V _ \| '_ \/ __| __/ _ \ '__| |_  | | '__/ _ \   " )
                print( r"   | |_| | |_| | | | | | | |_) \__ \ ||  __/ |  |  _| | | | |  __/   " )
                print( r"   |____/ \__,_|_| |_| |_| .__/|___/\__\___|_|  |_|   |_|_|  \___|   " )
                print( "                         |_|                                         " )
                print( "" )
