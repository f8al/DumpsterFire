...
class write_files_until_partition_full( FireModule ):
        ...
        def Configure( self ):
                self.mTargetDirectory = input( "Enter target directory (Ex. /tmp/): " )
                return
        ...
        def NomNom( self, kBytes ):
                ...
                try:
                        while( True ):
                                ...
                                self.file.write( ''.join([ random.choice( string.ascii_letters + string.digits ) for n in range( kBytes * 1024 )]))
                                self.file.close()
        ...
        def GenerateFilename( self ):
                ...
                try:
                        ...
                        self.mFilename = ''.join([ random.choice( string.ascii_letters + string.digits ) for n in range( 24 )])
